...
def add_mim_extention():
    """Add extra files that are required to support MIM."""
...
if __name__ == '__main__':
    ...
    setup(
        ...
        ext_modules=[
            make_cuda_ext(
                name='ops',
                module='mmdet3d.models.ops.softgroup_ops',
                sources=['src/softgroup_api.cpp', 'src/softgroup_ops.cpp'],
                sources_cuda=['src/cuda.cu'],
                extra_args=['-g'])
        ],
