...
class FFN(BaseModule):
    ...
    def __init__(self, d_model, hidden_dim, dropout, activation_fn):
        ...
        self.net = nn.Sequential(
            ...
            nn.Dropout(dropout), nn.Linear(hidden_dim, d_model),
            nn.Dropout(dropout))
        self.norm = nn.LayerNorm(d_model)
...
class QueryDecoder(BaseModule):
    ...
    Args:
        ...
        pos_enc_flag (bool): Whether to use positional encoding.
    """
...
class OneDataQueryDecoder(BaseModule):
    ...
    def __init__(self, num_layers, num_queries_1dataset, num_queries_2dataset,
                 num_classes_1dataset, num_classes_2dataset, prefix_1dataset,
                 prefix_2dataset, in_channels, d_model, num_heads, hidden_dim,
                 dropout, activation_fn, iter_pred, attn_mask, fix_attention,
                 **kwargs):
        super().__init__()
        self.input_proj = nn.Sequential(
