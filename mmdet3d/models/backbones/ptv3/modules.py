# VENDORED from Pointcept (pointcept/models/modules.py).
# Modifications:
#   - `from pointcept.models.utils.structure import Point` -> `from .structure import Point`
#   - dropped `from pointcept.engines.hooks import HookBase` and `class PointModel`
#     (PointModel pulls in the Pointcept training engine and is unused by PTv3).
# `PointModule` / `PointSequential` are unmodified.
