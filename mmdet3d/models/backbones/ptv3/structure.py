# VENDORED from Pointcept (pointcept/models/utils/structure.py).
# Modification: imports rewritten to package-relative
#   `from pointcept.models.utils.serialization import encode` -> `from .serialization import encode`
#   `from pointcept.models.utils import (...)`                -> `from .misc import (...)`
# Function bodies unmodified.
