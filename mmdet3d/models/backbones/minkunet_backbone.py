...
from mmdet3d.models.layers.minkowski_engine_block import (IS_MINKOWSKI_ENGINE_AVAILABLE,
                                                          ...
                                                          MinkowskiConvModule)
from mmdet3d.models.layers.sparse_block import (SparseBasicBlock, SparseBottleneck,
                                                make_sparse_convmodule, replace_feature)
from mmdet3d.models.layers.spconv import IS_SPCONV2_AVAILABLE
from mmdet3d.models.layers.torchsparse import IS_TORCHSPARSE_AVAILABLE
from mmdet3d.models.layers.torchsparse_block import (TorchSparseBasicBlock, TorchSparseBottleneck,
                    ...
                    encoder_layer.append(
                        residual_block(
                            ...
                            downsample=residual_branch(
                                encoder_channels[i], encoder_channels[i + 1], kernel_size=1)
                    ...
                    decoder_layer.append(
                        residual_block(
                            ...
                            downsample=residual_branch(
                                decoder_channels[i + 1] + encoder_channels[-2 - i],
                                decoder_channels[i + 1],
                                kernel_size=1) if residual_branch is not None else None,
