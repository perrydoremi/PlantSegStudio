...
split = 's6'
train_area=[1, 2, 3, 4, 5, 7, 8, 12, 16, 17, 18, 19, 20, 21, 22, 23, 24, 26, 29, 30, 31, 32, 33, 35, 37, 38, 39, 40, 41, 42, 43, 44, 45, 47, 49, 50, 51, 52, 53, 54, 55, 57, 58, 59, 60, 61, 63, 65, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 77, 79, 80, 81, 82, 85, 86, 89, 90, 93, 94, 95, 96, 97]
test_area=[6, 9, 10, 11, 13, 14, 15, 25, 27, 28, 34, 36, 46, 48, 56, 62, 64, 66, 78, 83, 84, 87, 88, 91, 92, 98]
...
wandb_run_name = (f'{plant_type}-DSPVFormer_scatter_v2_DQcat_'
                  ...
                  f'QuantizeLinearV1_noInit_full_{split}_4')

work_dir = 'work_dirs/DSPVFormer3d/random_split/COS_s6'
