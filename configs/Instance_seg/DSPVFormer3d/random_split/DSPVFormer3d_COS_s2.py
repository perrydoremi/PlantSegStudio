...
split = 's2'
train_area=[1, 2, 4, 5, 6, 7, 8, 9, 10, 13, 17, 18, 19, 21, 22, 23, 27, 29, 30, 31, 33, 34, 35, 36, 37, 38, 39, 40, 41, 43, 44, 45, 47, 48, 49, 50, 52, 54, 55, 56, 58, 60, 61, 62, 63, 65, 66, 67, 68, 69, 70, 71, 72, 75, 76, 78, 79, 80, 81, 83, 84, 85, 86, 87, 90, 91, 92, 93, 94, 95, 96, 97]
test_area=[3, 11, 12, 14, 15, 16, 20, 24, 25, 26, 28, 32, 42, 46, 51, 53, 57, 59, 64, 73, 74, 77, 82, 88, 89, 98]
...
wandb_run_name = (f'{plant_type}-DSPVFormer_scatter_v2_DQcat_'
                  ...
                  f'QuantizeLinearV1_noInit_full_{split}_2')

work_dir = 'work_dirs/DSPVFormer3d/random_split/COS_s2'
