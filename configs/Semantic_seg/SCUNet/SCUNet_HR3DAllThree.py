_base_ = [
    '../../_base_/models/spconvunet.py',
    '../../_base_/schedules/seg-cosine-200e.py',
    '../../_base_/default_runtime.py'
]
# Dataset settings
plant_type = 'HR3DAllThree'
use_color = False
point_cloud_range = [0, 0, 0, 261, 291, 300]
voxel_size = [1, 1, 1]
...
train_area = list(range(1, 81)) + list(range(106, 317)) + list(range(418, 504))
test_area = list(range(81, 106)) + list(range(317, 418)) + list(
    range(504, 547))

# inferences speed settings
# test_area.remove(81)
# test_area.remove(82)
# test_area.remove(94)
# test_area.remove(95)
# test_area.remove(317)
# test_area.remove(330)
# test_area.remove(331)
# test_area.remove(332)
# test_area.remove(344)
# test_area.remove(349)
# test_area.remove(369)
# test_area.remove(370)
# test_area.remove(371)
# test_area.remove(372)
# test_area.remove(393)
# test_area.remove(515)
# test_area.remove(536)
backend_args = None
# Model settings
bs = 32
max_epoch = 250
