...
backend_args = None
# Model settings
# enable_flash=True permits MinkUnet-parity bs=32 at the native voxel size
# (flash attention is O(N) in memory); best variant used patch size 1024.
bs = 32
max_epoch = 250
val_interval = 4
